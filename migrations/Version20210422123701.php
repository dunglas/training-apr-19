 ...
 */
final class Version20210422123701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movie AS SELECT id, author_id, title, poster, country, released, price FROM movie');
        ...
        $this->addSql('INSERT INTO movie (id, author_id, title, poster, country, released, price) SELECT id, author_id, title, poster, country, released, price FROM __temp__movie');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movie AS SELECT id, author_id, title, poster, country, released, price FROM movie');
        $this->addSql('DROP TABLE movie');
        $this->addSql('CREATE TABLE movie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, poster VARCHAR(255) DEFAULT NULL, country VARCHAR(2) DEFAULT NULL, released DATE DEFAULT NULL, price NUMERIC(10, 0) DEFAULT NULL)');
        $this->addSql('INSERT INTO movie (id, author_id, title, poster, country, released, price) SELECT id, author_id, title, poster, country, released, price FROM __temp__movie');
        $this->addSql('DROP TABLE __temp__movie');
        $this->addSql('CREATE INDEX IDX_1D5EF26FF675F31B ON movie (author_id)');
