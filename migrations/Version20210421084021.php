 ...
 */
final class Version20210421084021 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book AS SELECT id, author_id, title, summary FROM book');
        $this->addSql('DROP TABLE book');
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, summary CLOB DEFAULT NULL, author_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO book (id, author_id, title, summary) SELECT id, author_id, title, summary FROM __temp__book');
        $this->addSql('DROP TABLE __temp__book');
        $this->addSql('CREATE INDEX IDX_CBE5A331F675F31B ON book (author_id)');
    }
